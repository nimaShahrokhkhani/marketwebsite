...
class MasterCategoriesManager extends Component {
    constructor(props) {
        super(props);
        this.state = {
            items: [],
    ...
    deleteItemFromState = (name) => {
        Services.deleteMasterCategory({name: name}).then((response) => {
            ...
            <>
                {isDone && !isLoading ?
                    <Container className="AppContainer">
                        <Row>
                            <Col>
                                <h1 style={{margin: "20px 0", display: 'flex', fontSize: 30}}>Master Categories</h1>
                            </Col>
                        </Row>
                        <Row>
                            <Col>
...
export default MasterCategoriesManager
